    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 w-full flex-1 flex items-center">
        <div className="flex items-start gap-8 relative w-full">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                {config.primaryButton && (
                  <a
                    ...
                    className="px-6 py-2.5 bg-gray-900 text-white rounded-full text-sm font-normal hover:bg-gray-800 transition-colors"
                  >
                ...
                {config.secondaryButton && (
                  <a
                    ...
                    className="px-6 py-2.5 bg-transparent border border-gray-300 text-gray-700 rounded-full text-sm font-normal hover:bg-gray-50 transition-colors"
                  >
          ...
          {/* Right Image - 35% */}
          <div className="w-[35%] flex items-start justify-center relative">
            {config.rightImage ? (
              <img
      ...
      <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 z-20 flex flex-col items-center">
        ...
        <span className="text-gray-900 text-sm font-medium mb-0.5">More?</span>
        
        {/* Wide, shallow dark curved band peeking up - bell curve shape */}
        <div className="relative" style={{ width: '320px', height: '20px' }}>
          <svg 
            width="320" 
            height="20" 
            viewBox="0 0 320 20" 
