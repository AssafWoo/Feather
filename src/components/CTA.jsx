...
const CTA = ({ config }) => {
  ...
  return (
    <section id="cta" aria-label="Call to action" className={`py-16 px-4 sm:px-6 lg:px-8 ${styles.backgroundColor || 'bg-gray-900'} min-h-screen snap-start flex items-center relative`} style={{ scrollSnapStop: 'always' }}>
